...
namespace Sistema_Reserva_Alquiler_Habi.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,nombre,correo,consulta1")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,nombre,correo,consulta1")] Consulta consulta)
        {
            if (ModelState.IsValid)
            {
